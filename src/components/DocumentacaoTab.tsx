...
const INDICE_FORMULARIO = [
  ...
  { id: 'f-achados',     label: '2.2 Achados' },
  { id: 'f-nodulo',      label: '2.2.1 Nódulo' },
  { id: 'f-calc',        label: '2.2.2 Calcificações' },
  { id: 'f-distorcao',   label: '2.2.3 Distorção' },
  { id: 'f-assimetria',  label: '2.2.4 Assimetria' },
  { id: 'f-localizacao', label: '2.3 Localização' },
  { id: 'f-associados',  label: '2.4 Achados Assoc.' },
  { id: 'f-obs',         label: '2.5 Observações' },
